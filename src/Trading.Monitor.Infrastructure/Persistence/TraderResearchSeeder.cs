...
public static class TraderResearchSeeder
{
    ...
    private static async Task SeedProfilesAsync(TradingMonitorDbContext dbContext, DateTimeOffset now, CancellationToken cancellationToken)
    {
        var profiles = new[]
        {
            ...
            Profile("Binance", "Lead Traders ranking", "binance-lead-traders", "https://www.binance.com/en/copy-trading", "BTC/ETH/altcoins", "Lead trader", "Ranking publico de lead traders crypto.", "Revisar ROI, AUM, max drawdown y Sharpe dentro de Binance.", "Ranking publico; historial completo requiere Binance.", "Priorizar spot si no tienes BTC/ETH ni futuros."),
